...
class MonstersControllerTest < ActionController::TestCase
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post :create, monster: { level: @monster.level, name: @monster.name, role: @monster.role, subrole: @monster.subrole }
    end
  ...
  test "should update monster" do
    put :update, id: @monster, monster: { level: @monster.level, name: @monster.name, role: @monster.role, subrole: @monster.subrole }
    assert_redirected_to monster_path(assigns(:monster))
  end
